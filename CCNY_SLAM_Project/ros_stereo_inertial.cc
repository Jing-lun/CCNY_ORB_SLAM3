...
int main(int argc, char **argv)
{
    ...
    ros::Subscriber sub_img0 = n.subscribe("/mynteye/left/image_raw", 100, img0_callback);
    ros::Subscriber sub_img1 = n.subscribe("/mynteye/right/image_raw", 100, img1_callback);
